  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-20">
      ...
      <p className="text-gray-400 max-w-2xl mb-10">
        System #002 is a clean, stealth-focused performance build assembled with precision airflow,
        clean cable management, synchronized aRGB via NZXT CAM, and an upgrade-ready design.
      </p>
